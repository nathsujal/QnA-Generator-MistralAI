...
def llm_pipeline(text):
    ...
    document_ques_gen, document_answer_gen = data_processing(text)
...
def main():
  st.set_page_config("QnA Generator")
  st.header("QnA Generator using MistralAI")

  pdf_doc = st.file_uploader("Upload your PDF File")
  if st.button("Submit & Process"):
    with st.spinner("Processing..."):
      ...
      print(text)
      print("\n\n")
      answer_generation_chain, ques_list = llm_pipeline(text)
      for question in ques_list:
